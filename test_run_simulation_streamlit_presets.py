"""
SuperScript local simulation runner for testing parameter Presets.
===========

Data are saved to disk at: simulation_io/streamlit_presets/<BATCH_NAME> and log files are produced for each
...
def run_sim(parameters):
    ...
    save_dir = './simulation_io/streamlit_presets/' + batch_name
    os.mkdir(save_dir)
