...
BATCH_NAME = 'deptwl_0.6_r5_050421_v0.1' #'test_run_260321_v0.0'

# These global configuration values override config.py and will be
# used in all the simulations:
REPLICATE_COUNT = 5 # Number of replicate simulations to run
...
DEPARTMENTAL_WORKLOAD = 0.6  # Fraction of department capacity to keep
                             # free for dept work.
